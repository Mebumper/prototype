import locked from '../images/Besar.svg'
...
const Transisi_1 = () => {
    ...
    const scoreStage1 = location.state.scoreStage1
    const click = () => {
        navigate("/Stage_2", {state:{scoreStage1}})
    }
    return(
        <div className='flex justify-center items-center px-2 '>
            <div className='w-[390px]'>
                ...
                <div className="left-[137px] top-[76px] absolute text-center text-sky-500 text-sm font-extrabold font-['Inter']">Level 2 unlocked</div>
                <div className="left-[128px] top-[504px] absolute text-center text-stone-600 text-5xl font-normal font-['Lalezar']">Level 2</div>
                <div className="w-96 h-96 left-[7px] top-[90px] absolute">
                    ...
                    <img className="w-64 h-60 left-[54px] top-[130px] absolute" src={locked}/>
                </div>
                <div className=" left-[102px] top-[603px] absolute bg-sky-500 rounded-3xl justify-center items-center inline-flex">
